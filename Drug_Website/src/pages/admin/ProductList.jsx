                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-base-100 p-8 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-8 border-b pb-6">
                                            ...
                                            <div className="grid grid-cols-1 gap-6">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">SKU</label>
                                                        <input
                                                            type="text"
                                                            className="input input-bordered input-lg w-full"
                                                            value={formData.sku}
                                                    ...
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">Đơn vị</label>
                                                        <input
                                                            type="text"
                                                            className="input input-bordered input-lg w-full"
                                                            value={formData.unit}
                                                ...
                                                <div>
                                                    <label className="block text-base font-medium mb-2">Mô tả</label>
                                                    <textarea
                                        ...
                                        {/* Nhóm 2: Thông tin phân loại */}
                                        <div className="mb-8 border-b pb-6">
                                            <h4 className="text-lg font-medium mb-4">Phân loại</h4>
                                            <div className="grid grid-cols-1 gap-6">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">Yêu cầu đơn thuốc</label>
                                                        <input
                                                            type="checkbox"
                                                    ...
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">Trạng thái</label>
                                                        <select
                                                            className="select select-bordered select-lg w-full"
                                        ...
                                        <div className="mb-8">
                                            <h4 className="text-lg font-medium mb-4">Thông tin chi tiết</h4>
                                            <div className="grid grid-cols-1 gap-6">
                                                <div>
                                                    <label className="block text-base font-medium mb-2">Thành phần</label>
                                                    <textarea
                                                        className="textarea textarea-bordered textarea-lg w-full"
                                                        rows="3"
                                                ...
                                                <div>
                                                    <label className="block text-base font-medium mb-2">Hướng dẫn sử dụng</label>
                                                    <textarea
                                                        className="textarea textarea-bordered textarea-lg w-full"
                                                        rows="3"
                                                ...
                                                <div>
                                                    <label className="block text-base font-medium mb-2">Chống chỉ định</label>
                                                    <textarea
                                                        className="textarea textarea-bordered textarea-lg w-full"
                                                        rows="3"
                                                ...
                                                <div>
                                                    <label className="block text-base font-medium mb-2">Tác dụng phụ</label>
                                                    <textarea
                                                        className="textarea textarea-bordered textarea-lg w-full"
                                                        rows="3"
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">Điều kiện bảo quản</label>
                                                        <input
                                                            type="text"
                                                            className="input input-bordered input-lg w-full"
                                                    ...
                                                    <div>
                                                        <label className="block text-base font-medium mb-2">Đóng gói</label>
                                                        <input
                                                            type="text"
                                                            className="input input-bordered input-lg w-full"
                                                ...
                                                <div>
                                                    <label className="block text-base font-medium mb-2">URL hình ảnh</label>
                                                    <input
                                                        type="text"
                                                        className="input input-bordered input-lg w-full"
